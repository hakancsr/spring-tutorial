...
@Aspect
public class CagirilanMetodunOnvesiVeSonrasiOzellikleri {

	@Around("execution(* com.mimaraslan.IPersonelServis.adiSoyadiKontrolEt(..))")
	public void secilenMetoduSar(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		System.out.println(
				"### Aspectj ### " + "Çağırılan metodun argümentleri : " + Arrays.toString(joinPoint.getArgs()));
